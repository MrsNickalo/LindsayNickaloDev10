 ...
 */
package com.tsguild.foundations.variable;
public class MoreBucketsMoreFun {
    public static void main(String[] args){
        ...
        System.out.println("There are only " + butterflies + ", ");
        System.out.println("but " + bugs + " bugs total.");
        System.out.println("Uh oh, my dog ate one.");
        butterflies--;
        System.out.println("Nnow there are only " + butterflies + " butterflies left.");
